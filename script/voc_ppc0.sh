...
TRAINED_WEIGHT=train_log/${SESSION}/checkpoint_last.pth

echo "train set Inference"
...
CUDA_VISIBLE_DEVICES=${GPU} python3 eval.py \
    ...
    --predict_dir   train_log/${SESSION}/result/train/cam_npy \
    --gt_dir        ${GT_ROOT} \
    --comment       ${SESSION} \
...
# ################################ If full inference of train_aug set needed ################################
